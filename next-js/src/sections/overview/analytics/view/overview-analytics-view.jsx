      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 12, md: 6, lg: 4 }}>
          <AnalyticsCurrentVisits
            ...
            chart={{
              series: [
                { label: user.displayName, value: 3500 },
                { label: user.role, value: 2500 },
                { label: user.displayName, value: 1500 },
                { label: user.role, value: 500 },
              ],
            }}
          />
        </Grid>
        ...
        <Grid size={{ xs: 12, md: 6, lg: 8 }}>
          <AnalyticsWebsiteVisits
            ...
            chart={{
              ...
              series: [
                { name: 'IOTA', data: [43, 33, 22, 37, 67, 68, 37, 24, 55] },
                { name: 'Partner', data: [51, 70, 47, 67, 40, 37, 24, 70, 24] },
              ],
            }}
          />
        </Grid>
