...
export async function PATCH(request, { params }) {
  try {
    ...
    const res = await fetch(`${BASE_URL}/todo/subtasks/${params.id}`, {
      method: 'PATCH',
    ...
    console.error('Proxy /api/todo/subtasks/:id PATCH failed', error);
...
export async function DELETE(_request, { params }) {
  try {
    ...
    console.error('Proxy /api/todo/subtasks/:id DELETE failed', error);
