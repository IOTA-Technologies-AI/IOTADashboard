...
export async function POST() {
  try {
    const res = await fetch(`${BASE_URL}/todo/reminders/dispatch`, {
      method: 'POST',
    ...
    console.error('Proxy /api/todo/reminders/dispatch failed', error);
    return NextResponse.json({ message: 'Failed to dispatch reminders' }, { status: 500 });
  }
}
