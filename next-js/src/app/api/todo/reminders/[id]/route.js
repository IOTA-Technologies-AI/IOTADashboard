...
export async function PATCH(request, { params }) {
  try {
    ...
    const res = await fetch(`${BASE_URL}/todo/reminders/${params.id}`, {
      method: 'PATCH',
    ...
    console.error('Proxy /api/todo/reminders/:id PATCH failed', error);
...
export async function DELETE(_request, { params }) {
  try {
    ...
    console.error('Proxy /api/todo/reminders/:id DELETE failed', error);
