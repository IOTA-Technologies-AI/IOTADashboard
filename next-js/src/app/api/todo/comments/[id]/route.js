...
export async function PATCH(request, { params }) {
  try {
    ...
    const res = await fetch(`${BASE_URL}/todo/comments/${params.id}`, {
      method: 'PATCH',
    ...
    console.error('Proxy /api/todo/comments/[id] PATCH failed', error);
...
export async function DELETE(request, { params }) {
  try {
    ...
    console.error('Proxy /api/todo/comments/[id] DELETE failed', error);
