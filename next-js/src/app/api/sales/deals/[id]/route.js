...
export async function GET(_request, { params }) {
  try {
    const res = await fetch(`${BASE_URL}/sales/deals/${params.id}`, {
      method: 'GET',
    ...
    console.error('Proxy /api/sales/deals/[id] GET failed', error);
...
export async function PATCH(request, { params }) {
  try {
    ...
    console.error('Proxy /api/sales/deals/[id] PATCH failed', error);
...
export async function DELETE(_request, { params }) {
  try {
    ...
    console.error('Proxy /api/sales/deals/[id] DELETE failed', error);
