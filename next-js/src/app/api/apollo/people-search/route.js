...
export async function POST(request) {
  try {
    ...
    const res = await fetch(`${BASE_URL}/apollo/people-search`, {
      method: 'POST',
    ...
    console.error('Proxy /api/apollo/people-search POST failed', error);
    return NextResponse.json({ message: 'Apollo people search failed' }, { status: 500 });
  }
}
