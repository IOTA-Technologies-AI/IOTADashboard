...
export async function POST(request) {
  try {
    ...
    const res = await fetch(`${BASE_URL}/apollo/people-enrich`, {
      method: 'POST',
    ...
    console.error('Proxy /api/apollo/people-enrich POST failed', error);
    return NextResponse.json({ message: 'Apollo people enrich failed' }, { status: 500 });
  }
}
