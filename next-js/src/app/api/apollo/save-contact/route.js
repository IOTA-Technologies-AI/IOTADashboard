...
export async function POST(request) {
  try {
    ...
    const res = await fetch(`${BASE_URL}/apollo/contacts/save`, {
      method: 'POST',
    ...
    console.error('Proxy /api/apollo/save-contact POST failed', error);
    return NextResponse.json({ message: 'Apollo save contact failed' }, { status: 500 });
  }
}
