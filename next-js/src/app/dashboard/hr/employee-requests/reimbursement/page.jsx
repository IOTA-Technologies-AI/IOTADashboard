...
export default function ReimbursementListPage() {
  ...
  useEffect(() => {
    listRequests()
      .then((data) => setRows(data?.reimbursementRequests ?? []))
      .catch((e) => console.error('Failed to load reimbursements:', e))
      .finally(() => setLoading(false));
  }, []);

  const handleViewRow = useCallback(
    (id) => router.push(paths.dashboard.hr.employeeRequests.reimbursement.details(id)),
    [router]
  );
      ...
      <CustomBreadcrumbs
        ...
        action={
          <Button
            ...
            href={paths.dashboard.hr.employeeRequests.reimbursement.new}
            variant="contained"
