...
export default function ServiceRequestsListPage() {
  ...
  useEffect(() => {
    listRequests()
      .then((data) => setRows(data?.serviceRequests ?? []))
      .catch((e) => console.error('Failed to load service requests:', e))
      .finally(() => setLoading(false));
  }, []);

  const handleViewRow = useCallback(
    (id) => router.push(paths.dashboard.hr.employeeRequests.service.details(id)),
    [router]
  );
      ...
      <CustomBreadcrumbs
        ...
        action={
          <Button
            ...
            href={paths.dashboard.hr.employeeRequests.service.new}
            variant="contained"
